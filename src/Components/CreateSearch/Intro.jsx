...
function Intro() {
    ...
    return (
        <div className="new-container">
            <h2 className="new-title">Introdução ({blockStates.count < 10 ? "0" + blockStates.count : blockStates.count} de 10)</h2>
            <textarea
            ...
            <br />
            {
                current.question.length > 4 && current.type !== null && (
                    <div className="new-btn-container">
                        {
                            !blockStates.ready ? (
                                <>
                                    {
                                        blockStates.count < 10 && (
                                            <NewQuestion 
